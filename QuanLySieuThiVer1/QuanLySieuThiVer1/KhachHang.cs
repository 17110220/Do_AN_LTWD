    ...
    public partial class KhachHang : Form
    {
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                // Thực hiện lệnh
                BLKhachHang blKH = new BLKhachHang();
                blKH.CapNhatKhachHang(this.txtmakh.Text, this.txttenkh.Text, this.txtdiachi.Text, this.txtdienthoai.Text, ref err);// Load lại dữ liệu trên DataGridView
                LoadData();
                // Thông báo
